            ...
            <div style="padding: 24px;">
              ...
              <div id="feexpay-personal-info" style="margin-bottom: 24px;${hidePersonalInfoSection ? ' display: none;' : ''}">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                  <input type="text" id="feexpay-name-input" placeholder="Nom et Prénoms" style="width: 100%; height: 20px; padding: 8px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;${hideNameField ? ' display: none;' : ''}">
                  <input type="email" id="feexpay-email-input" placeholder="Email" style="width: 100%; height: 20px; padding: 8px; border: 1px solid #d1d5db; border-radius: 4px; outline: none;${hideEmailField ? ' display: none;' : ''}">
                </div>
              </div>
